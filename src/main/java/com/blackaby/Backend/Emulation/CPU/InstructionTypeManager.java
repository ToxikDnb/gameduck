...
public class InstructionTypeManager {
    ...
    public enum InstructionType {
        ...
        public static final InstructionType[] OpcodeExtractingTypes = {
                ...
                CP_REGISTER, INC_REGISTER, DEC_REGISTER, AND_REGISTER, OR_REGISTER, XOR_REGISTER,
                INC_REGISTER_16,
                DEC_REGISTER_16, ADD_PAIR_TO_HL, ROTATE_LEFT_CIRCLE_ACCUMULATOR,
                ROTATE_RIGHT_CIRCLE_ACCUMULATOR,
                ROTATE_LEFT_ACCUMULATOR, ROTATE_RIGHT_ACCUMULATOR, ROTATE_LEFT_CIRCLE_REGISTER,
                ROTATE_RIGHT_CIRCLE_REGISTER, ROTATE_LEFT_REGISTER, ROTATE_RIGHT_REGISTER,
                SHIFT_LEFT_ARITHMETIC_REGISTER,
                SHIFT_RIGHT_ARITHMETIC_REGISTER, SWAP_NIBBLES_REGISTER, SHIFT_RIGHT_LOGICAL_REGISTER,
                TEST_BIT_REGISTER,
                RESET_BIT_REGISTER, SET_BIT_REGISTER, JUMP_UNCONDITIONAL, JUMP_CONDITIONAL,
                JUMP_RELATIVE_UNCONDITIONAL,
                JUMP_RELATIVE_CONDITIONAL, CALL_UNCONDITIONAL, CALL_CONDITIONAL, RETURN_CONDITIONAL,
                RESTART_UNCONDITIONAL,
        };
